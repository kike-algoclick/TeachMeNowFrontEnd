    ...
    <div className="app-container">
      <div className="card">
        ...
        <div className="content">
          ...
          <p className="subtitle"><b>Descubre tu estilo de aprendizaje</b></p>
          <div className="Cuadrito">
            <p className="description">
            Cada persona aprende de forma diferente. Comprender tu estilo de 
            aprendizaje preferido puede ayudarte a estudiar con mayor eficacia y a retener mejor la información.
          </p>
          </div>
          <div className="grid">
            ...
            <div className="info-box">
              ...
              <ul>
                ...
                <li>
                  Este cuestionario fue creando basandonos en el Test <b>CHAEA</b>.
                </li>
