      ...
      <div className="landing-page">
        ...
        <section className="learning-style-section">
          ...
          <div className="learning-options">
            ...
            <div className="learning-card">
              <img
                src="https://i.pinimg.com/736x/28/b2/b4/28b2b4a0f52b0c829255c7859a60ee94.jpg"
                wei
              />
              <p>
                <b>Escucha</b>
