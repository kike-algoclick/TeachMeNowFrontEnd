    ...
    return(
        ...
        <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-sm mx-auto">
            ...
            <div className="mb-4 text-center">
                ...
                <a href="#" className="text-blue-500 font-semibold hover:underline ml-1" style={{ color: "#1A3D63" }}>Sign up</a>
            </div>
            ...
            <div className="mt-6 space-y-3">
                <button type="button" className="w-full flex items-center justify-center border rounded-md py-2 text-gray-700 hover:bg-gray-100 transition-colors duration-300">
                    <img src="https://avatars.githubusercontent.com/u/51489386?s=200&v=4" alt="Microsoft" className="w-5 h-5 mr-2" />
                    <span>Login with Microsoft</span>
                </button>
                <button type="button" className="w-full flex items-center justify-center border rounded-md py-2 text-gray-700 hover:bg-gray-100 transition-colors duration-300">
                    <img src="https://th.bing.com/th/id/R.16597b58fb4d4fa8ebcf5a013fc19b0a?rik=a0DcRRp3bMzLow&pid=ImgRaw&r=0" alt="Google" className="w-5 h-5 mr-2" />
                    <span>Login with Google</span>
                </button>
                <button type="button" className="w-full flex items-center justify-center border rounded-md py-2 text-gray-700 hover:bg-gray-100 transition-colors duration-300">
                    <img src="https://static.vecteezy.com/system/resources/previews/018/930/698/original/facebook-logo-facebook-icon-transparent-free-png.png" alt="Facebook" className="w-5 h-5 mr-2" />
